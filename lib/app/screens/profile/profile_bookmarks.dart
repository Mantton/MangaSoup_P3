...
class ComicBookMarksPage extends StatelessWidget {
  ...
  const ComicBookMarksPage({Key key, @required this.comicId, @required this.profile}) : super(key: key);
            ...
            appBar: AppBar(
              ...
              actions: [
                bookmarks.isNotEmpty
                    ? IconButton(
                  icon: Icon(Icons.delete_forever, color: Colors.transparent,),
                  onPressed: ()=>null,
                )
                    : Container(),
              ],
                  ...
                  ListTile(
                      ...
                      onTap: ()=>      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) => ReaderHome(
                            ...
                            initialChapterIndex:
                            profile.chapters.indexOf(profile.chapters.firstWhere((element) => element.link == bookmarks[index].chapterLink)),
                            comicId: comicId,
                    ...
                    ,
                      ...
                      trailing: IconButton(
                        ...
                        onPressed: () =>
                            provider.deleteBookMark(bookmarks[index]),) ,
                  ),
            ),
          );
        });
